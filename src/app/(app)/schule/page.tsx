...
import { listKinder, listFaecher, listNoten, kontostand, listTaschengeld, getSparziel } from "./actions";
...
export default async function SchulePage() {
  ...
  return <SchuleClient istEltern={!!istEltern} eigeneId={person!.id} kinder={kinderDaten} />;
}
