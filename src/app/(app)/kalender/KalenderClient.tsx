...
export default function KalenderClient({
  ...
  // Fix-Batch 96 (Florians Wunsch): ICS-Import-Vorschau, bevor irgendetwas gespeichert wird.
  ...
  // Fix-Batch 96 (Florians Wunsch): ICS-Datei einlesen und als Vorschau anzeigen — es wird
  // dabei noch NICHTS gespeichert, siehe icsImport.ts für die Parsing-Strategie.
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {/* Fix-Batch 96 (Florians Wunsch): Umzug von Faminice — Termine aus einer exportierten
          ICS-Datei importieren. Nur Eltern, da es potenziell viele Termine auf einmal anlegt. */}
      {istEltern && (
        <details>
          <summary style={{ cursor: "pointer", color: "var(--text-muted)" }}>📥 Termine aus einer Kalender-Datei importieren (ICS)</summary>
